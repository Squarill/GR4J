...
REM Following line is for the q data obtained by GRDC in NetCDF format. remove the "REM" if needed. Since GRDC data is already clipped, there is no need to apply a sellonlatbox command.
